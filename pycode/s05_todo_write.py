...
Changes from s04:
  ...
  + Nag reminder (inject reminder after 3 rounds without to—do update)
...
def run_todo_write(todos: list) -> str:
    global CURRENT_TODOS # 全局变量，用来存储当前的任务列表。
    ...
    for t in CURRENT_TODOS:
        icon = {"pending": " ", "in_progress": "\033[36m▸\033[0m", "completed": "\033[32m✓\033[0m"}[t["status"]] # 根据任务状态选择不同的图标。
